 ...
 * File created on 8/11/22, 2:41 PM by Carina The Latest changes made by Carina on 8/11/22, 2:31 PM All contents of "FXMLController" are protected by copyright.
...
import me.carinasophie.crosswise.util.filehandle.FileOutputWriter;
...
public class FXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.guiConnector = new FXGUI(playerHandOne, playerHandTwo, playerHandThree, playerHandFour, currentPlayerText, gameGrid, moverAmountText, swapperAmountText, replacerAmountText, removerAmountText, showComputerHandButton, verticalPointsGrid, horizontalPointsGrid, sumPointsVerticalTeam, sumPointsHorizontalTeam, imageSwapper, imageMover, imageReplacer, imageRemover);
