 ...
 * File created on 8/11/22, 2:41 PM by Carina The Latest changes made by Carina on 8/11/22, 2:31 PM All contents of "Game" are protected by copyright.
...
public class Game {
    ...
    public static void removeUsedTokensFromPile() {
        ...
        for (Token used : game.getUsedSpecialTokens()) {
